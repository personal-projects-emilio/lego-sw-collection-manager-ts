...
export const BurgerMenu: React.FC<BurgerMenuProps> = ({ isAuthenticate, logoutHandler }) => {
  ...
  return (
    <>
      ...
      >
        ...
        <MenuItem component={Link} to="/sets" selected={pathname === '/sets'} onClick={handleClose}>
          Sets
        </MenuItem>
        {isAuthenticate ? (
