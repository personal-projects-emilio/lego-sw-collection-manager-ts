...
export const NameAndTags: React.FC<NameAndTagsProps> = ({ tags, characterName }) => {
  ...
  return (
    <>
      <StyledChip
        ...
        onDelete={characterName === filters.characName ? () => characNameHandler(null) : undefined}
      />
      {Array.isArray(tags) && tags.length > 0 && <Divider variant="fullWidth" />}
      {tags?.map((tag) => (
        <StyledChip
