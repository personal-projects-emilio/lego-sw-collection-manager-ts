import { createSlice, createAsyncThunk, isPending, isFulfilled, isRejectedWithValue } from '@reduxjs/toolkit'
import api from 'api';
...
export const fetchFrames = createAsyncThunk<FramesList>('minifigs/fetchFrames',
